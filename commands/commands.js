...
module.exports = {
    ...
    callback: async({interaction, guild}) => {
        ...
        .setFooter('DO NOT TAKE ANYTHING THIS BOT SAYS SERIOUSLY (other than moderation) | <> is required, [] is optional | Most commands are slash only')
        ...
        if (cat === 'admin') {
            ...
            .addField('timeout', 'Timeout a user (basically mute but with no roles)\n**Usage:**\n\`/timeout <user> <duration> <true|false> <reason>\`')
